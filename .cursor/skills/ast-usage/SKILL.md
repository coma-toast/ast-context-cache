...
**Not for server config** (embeddings, dashboard settings, log retention) — use [ast-context-cache-operator](../ast-operator/SKILL.md) or `skills/operator/SKILL.md`.
...
| Dashboard | `http://localhost:7830` (operators — see [ast-context-cache-operator](../ast-operator/SKILL.md) or `skills/operator/SKILL.md`) |
