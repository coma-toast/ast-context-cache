...
<div class="card metric-card resource-util-card">
  ...
  <div class="resource-util-rows">
    ...
    <div class="resource-bar"><div class="resource-bar-head"><span class="resource-bar-label" title="Host load average (1 / 5 / 15 min) ÷ cores — 1.0× = fully utilized">Load avg</span><span class="resource-bar-value">2.36× · 1.71× · 1.92× · 5c</span></div><div class="channel-bar-track"><div class="channel-bar-fill level-critical" style="width:100%;background:#d2a8ff"></div></div></div>
