...
func ExampleFilterTools_core() {
	...
	// Output: get_context_capsule, index_status, get_impact_graph, diff_impact, check_symbol_exists, check_deletion_safety, fetch_context, list_context, search_context, recall_memory, search_semantic, get_project_map, get_file_context, search_docs, list_doc_sources, retrieve
}
...
func ExampleFilterTools_extended() {
	...
	fmt.Println(strings.Join(names, ", "))
	// Output: get_context_capsule, index_files, index_status, get_impact_graph, diff_impact, check_symbol_exists, check_deletion_safety, cache_summary, store_context, fetch_context, report_kv_repair_event, list_context, search_context, flush_context, store_memory, recall_memory, forget_memory, search_semantic, get_project_map, get_file_context, analyze_dead_code, analyze_complexity, export_bundle, import_bundle, search_docs, fetch_doc, add_doc_source, remove_doc_source, list_doc_sources, update_doc_source, retrieve
}
...
func ExampleFilterTools_complete() {
	...
	fmt.Println(strings.Join(names, ", "))
	// Output: get_context_capsule, index_files, index_status, get_impact_graph, diff_impact, check_symbol_exists, check_deletion_safety, cache_summary, store_context, fetch_context, report_kv_repair_event, list_context, search_context, flush_context, store_memory, recall_memory, forget_memory, search_semantic, get_project_map, get_file_context, analyze_dead_code, analyze_complexity, execute_code, export_bundle, import_bundle, search_docs, fetch_doc, add_doc_source, remove_doc_source, list_doc_sources, update_doc_source, retrieve
}
